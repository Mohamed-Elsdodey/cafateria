  ...
  <section class="container-fluid  ">
     <section class="row d-flex  ">
       ...
       <section class="col-12 col-sm-6 col-md-3  ">
                ...
                <form class="form-container " method="post" action="../controller/handleupdateproduct.php" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" name="productname" value=" <?php echo $_GET['productname']; ?>"  id="exampleInputEmail1" aria-describedby="emailHelp">
...
?>
                  ...
                  <input class="form-control price" type="number" name="productprice" value=<?php $pric=(double)$_GET['productprice'];echo $pric; ?>  step="0.5"  >
                  <span >EGP</span>
                   </div>
       <?php            
...
?>
                   ...
                   <select class="form-select" name="productcategory" aria-label="Default select example">
                    <option selected value=" <?php echo $_GET['productcategory']; ?>" > <?php echo $_GET['productcategory']; ?></option>
